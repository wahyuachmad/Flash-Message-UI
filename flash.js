...
function flash (message, options = null) {
  ...
  var $message = $(
    `<div class='flash_msg'><div class='main_flash'><div class='icon-flash'>${icon}</div>${message}</div><div class='bg_flash'></div></div>`
  )
